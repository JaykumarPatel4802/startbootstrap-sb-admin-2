...
// let rawdata = fs.readFileSync('././vendor/simulation_data.json');
...
//         console.log(myObj.numStudents);
//     }
// };
// xmlhttp.open("GET", "../../vendor/simulation_data.json", true);
// xmlhttp.send();
  ...
  options: {
    ...
    scales: {
      ...
      yAxes: [{
        ...
        scaleLabel: {
            display: true,
            labelString: 'Average Travel Time'
        }
      }],
    },
    legend: {
